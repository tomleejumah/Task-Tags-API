...
/**
 * This interface represents a repository for managing Task entities. It extends
...
public interface TaskRepository extends JpaRepository<Task, Long> {
   ...
   * @return An Optional containing the found Task entity if it exists, or an
   ...
   * @return A List containing all Task entities that match the given completion
   *         status.
   */
